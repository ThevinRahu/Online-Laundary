...
h1 {
 ...
 <h3>Total Price of Booking is = <%=value %>0 <br>Login to Book!</h3>
		...
		<form  method="post" action="LoginServlet">
			...
			<input type="text" name="value" hidden="hidden" value="<%=value %>0">
			<input type="text" name="value2" hidden="hidden" value="<%=value2 %>">
			<input type="text" name="value3" hidden="hidden" value="<%=value3 %>">
		</form>
	</div>
